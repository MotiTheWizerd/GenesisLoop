...
(function() {
  ...
  sendTestMessage: function() {
    ...
    if (typeof window.DOMUtils === 'undefined' || typeof window.Constants === 'undefined') {
    ...
    try {
      ...
      console.log("📝 Attempting to send message:", textToSend, "using:", elements.textarea.tagName);
      ...
      try {
        ...
        if (elements.textarea.tagName === "TEXTAREA") {
          ...
          if (elements.textarea.id === "prompt-textarea") {
            ...
            setTimeout(() => {
              if (elements.sendButton && (typeof window.MessageLoop !== 'undefined' && window.MessageLoop.isRunning)) {
                ...
                try {
                  ...
                  try {
                    ...
                    console.log(`Trying to click ${childElements.length} child elements`);
                ...
                console.log("❌ Cannot click send button - button missing or loop stopped");
              }
            }, 500);
          ...
          for (const assistantNode of assistants) {
            ...
            if (text.startsWith("{")) {
              ...
              if (openCount !== closeCount || !text.endsWith("}")) {
                console.log("⏳ JSON still streaming... waiting for completion");
